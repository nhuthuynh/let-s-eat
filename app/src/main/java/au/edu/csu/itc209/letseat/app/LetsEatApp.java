package au.edu.csu.itc209.letseat.app;
...
/**
 * Created by NhutHuynh on 9/23/17.
 */

public class LetsEatApp extends Application {

    private static final String DEFAULT_NORMAL_BOLD_FONT_FILENAME = "fonts/Roboto-Bold.ttf";
    private static final String DEFAULT_NORMAL_BOLD_ITALIC_FONT_FILENAME = "fonts/Roboto-BoldItalic.ttf";
    private static final String DEFAULT_NORMAL_ITALIC_FONT_FILENAME = "fonts/Roboto-Italic.ttf";
    private static final String DEFAULT_NORMAL_NORMAL_FONT_FILENAME = "fonts/Roboto-Regular.ttf";

    private static final String DEFAULT_SANS_BOLD_FONT_FILENAME = "fonts/Roboto-Bold.ttf";
    private static final String DEFAULT_SANS_BOLD_ITALIC_FONT_FILENAME = "fonts/Roboto-BoldItalic.ttf";
    private static final String DEFAULT_SANS_ITALIC_FONT_FILENAME = "fonts/Roboto-Italic.ttf";
    private static final String DEFAULT_SANS_NORMAL_FONT_FILENAME = "fonts/Roboto-Regular.ttf";

    private static final String DEFAULT_SERIF_BOLD_FONT_FILENAME = "fonts/Roboto-Bold.ttf";
    private static final String DEFAULT_SERIF_BOLD_ITALIC_FONT_FILENAME = "fonts/Roboto-BoldItalic.ttf";
    private static final String DEFAULT_SERIF_ITALIC_FONT_FILENAME = "fonts/Roboto-Italic.ttf";
    private static final String DEFAULT_SERIF_NORMAL_FONT_FILENAME = "fonts/Roboto-Regular.ttf";

    private static final String DEFAULT_MONOSPACE_BOLD_FONT_FILENAME = "fonts/Roboto-Bold.ttf";
    private static final String DEFAULT_MONOSPACE_BOLD_ITALIC_FONT_FILENAME = "fonts/Roboto-BoldItalic.ttf";
    private static final String DEFAULT_MONOSPACE_ITALIC_FONT_FILENAME = "fonts/Roboto-Italic.ttf";
    private static final String DEFAULT_MONOSPACE_NORMAL_FONT_FILENAME = "fonts/Roboto-Regular.ttf";
    ...
    private void setTypeFaceDefaults(Typeface normal, Typeface bold, Typeface italic, Typeface boldItalic, int typefaceIndex) throws NoSuchFieldException, IllegalAccessException {
        ...
        LongSparseArray<SparseArray<Typeface>> sTypefaceCacheLocal = new LongSparseArray<>(3);
        typeFacesField.get(sTypefaceCacheLocal);

        SparseArray<Typeface> newValues = new SparseArray<>(4);
